...
let NotificationsController = class NotificationsController {
    ...
    unread(req) { return this.svc.countUnread(req.orgId, req.user); }
    get(req, id) { return this.svc.get(req.orgId, id); }
    create(req, dto) { return this.svc.create(req.orgId, dto, req.user); }
    test(req, dto) { return this.svc.test(req.orgId, dto); }
    read(req, id) { return this.svc.markRead(req.orgId, id); }
    readAll(req) { return this.svc.markAllRead(req.orgId, req.user); }
