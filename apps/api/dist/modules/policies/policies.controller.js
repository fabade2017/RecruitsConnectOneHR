...
let PoliciesController = class PoliciesController {
    ...
    upload(req, dto, file) { return this.svc.upload(req.orgId, dto, file); }
    query(req, dto) { return this.svc.query(req.orgId, dto, req.user); }
...
__decorate([
    ...
    __metadata("design:returntype", void 0)
], PoliciesController.prototype, "get", null);
__decorate([
    (0, common_1.Post)(),
...
__decorate([
    ...
    __metadata("design:returntype", void 0)
], PoliciesController.prototype, "upload", null);
__decorate([
    ...
    __metadata("design:paramtypes", [Object, Object]),
    __metadata("design:returntype", void 0)
], PoliciesController.prototype, "query", null);
__decorate([
    (0, common_1.Patch)(':id'),
    (0, rbac_guard_1.RequirePermissions)('document:*'),
    __param(0, (0, common_1.Req)()),
